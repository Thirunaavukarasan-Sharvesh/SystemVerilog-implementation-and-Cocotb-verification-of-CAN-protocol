...
class alignas(VL_CACHE_LINE_BYTES) Vtop___024unit__03a__03agenerator__Vclpkg final {
  public:
...
class Vtop___024unit__03a__03agenerator : public virtual VlClass {
  public:
    ...
    VlClass* clone() const { return new Vtop___024unit__03a__03agenerator(*this); }
