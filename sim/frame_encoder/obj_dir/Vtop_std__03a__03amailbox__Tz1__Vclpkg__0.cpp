...
VlCoroutine Vtop_std__03a__03amailbox__Tz1::__VnoInFunc_put(Vtop__Syms* __restrict vlSymsp, VlClassRef<Vtop___024unit__03a__03atransaction> message) {
    ...
    // Locals
    CData/*0:0*/ __Vtrigprevexpr_haab34f89__0;
    __Vtrigprevexpr_haab34f89__0 = 0;
    // Body
    VL_KEEP_THIS;
    while (((0U != this->__PVT__m_bound) & VL_GTES_III(32, this->__PVT__m_queue.size(), this->__PVT__m_bound))) {
        if (VL_GTES_III(32, this->__PVT__m_queue.size(), this->__PVT__m_bound)) {
            CData/*0:0*/ __VdynTrigger_hd8bc1609__0;
            __VdynTrigger_hd8bc1609__0 = 0;
            __VdynTrigger_hd8bc1609__0 = 0U;
            while ((1U & (~ (IData)(__VdynTrigger_hd8bc1609__0)))) {
                co_await vlSymsp->TOP.__VdynSched.evaluation(
                                                             nullptr, 
                                                             "@([true] (std::mailbox__Tz1.m_queue.size() < std::mailbox__Tz1.m_bound))", 
                                                             "/usr/local/share/verilator/include/verilated_std.sv", 
                                                             51);
                __Vtrigprevexpr_haab34f89__0 = VL_LTS_III(32, this->__PVT__m_queue.size(), this->__PVT__m_bound);
                __VdynTrigger_hd8bc1609__0 = __Vtrigprevexpr_haab34f89__0;
                vlSymsp->TOP.__VdynSched.anyTriggered(__VdynTrigger_hd8bc1609__0);
            }
...
VlCoroutine Vtop_std__03a__03amailbox__Tz1::__VnoInFunc_get(Vtop__Syms* __restrict vlSymsp, VlClassRef<Vtop___024unit__03a__03atransaction> &message) {
    ...
    // Locals
    CData/*0:0*/ __Vtrigprevexpr_h1a72e676__0;
    __Vtrigprevexpr_h1a72e676__0 = 0;
    // Body
    VL_KEEP_THIS;
    while ((0U == this->__PVT__m_queue.size())) {
        if (VL_GTES_III(32, 0U, this->__PVT__m_queue.size())) {
            CData/*0:0*/ __VdynTrigger_h2c7cae96__0;
            __VdynTrigger_h2c7cae96__0 = 0;
            __VdynTrigger_h2c7cae96__0 = 0U;
            while ((1U & (~ (IData)(__VdynTrigger_h2c7cae96__0)))) {
                co_await vlSymsp->TOP.__VdynSched.evaluation(
                                                             nullptr, 
                                                             "@([true] (32'sh0 < std::mailbox__Tz1.m_queue.size()))", 
                                                             "/usr/local/share/verilator/include/verilated_std.sv", 
                                                             67);
                __Vtrigprevexpr_h1a72e676__0 = VL_LTS_III(32, 0U, this->__PVT__m_queue.size());
                __VdynTrigger_h2c7cae96__0 = __Vtrigprevexpr_h1a72e676__0;
                vlSymsp->TOP.__VdynSched.anyTriggered(__VdynTrigger_h2c7cae96__0);
            }
            co_await vlSymsp->TOP.__VdynSched.resumption(
                                                         nullptr, 
                                                         "@([true] (32'sh0 < std::mailbox__Tz1.m_queue.size()))", 
...
VlCoroutine Vtop_std__03a__03amailbox__Tz1::__VnoInFunc_peek(Vtop__Syms* __restrict vlSymsp, VlClassRef<Vtop___024unit__03a__03atransaction> &message) {
    ...
    // Locals
    CData/*0:0*/ __Vtrigprevexpr_h1a72e676__1;
    __Vtrigprevexpr_h1a72e676__1 = 0;
    // Body
    VL_KEEP_THIS;
    while ((0U == this->__PVT__m_queue.size())) {
        if (VL_GTES_III(32, 0U, this->__PVT__m_queue.size())) {
            CData/*0:0*/ __VdynTrigger_h2c7cae96__1;
            __VdynTrigger_h2c7cae96__1 = 0;
            __VdynTrigger_h2c7cae96__1 = 0U;
            while ((1U & (~ (IData)(__VdynTrigger_h2c7cae96__1)))) {
                co_await vlSymsp->TOP.__VdynSched.evaluation(
                                                             nullptr, 
                                                             "@([true] (32'sh0 < std::mailbox__Tz1.m_queue.size()))", 
                                                             "/usr/local/share/verilator/include/verilated_std.sv", 
                                                             84);
                __Vtrigprevexpr_h1a72e676__1 = VL_LTS_III(32, 0U, this->__PVT__m_queue.size());
                __VdynTrigger_h2c7cae96__1 = __Vtrigprevexpr_h1a72e676__1;
                vlSymsp->TOP.__VdynSched.anyTriggered(__VdynTrigger_h2c7cae96__1);
            }
            co_await vlSymsp->TOP.__VdynSched.resumption(
                                                         nullptr, 
                                                         "@([true] (32'sh0 < std::mailbox__Tz1.m_queue.size()))", 
