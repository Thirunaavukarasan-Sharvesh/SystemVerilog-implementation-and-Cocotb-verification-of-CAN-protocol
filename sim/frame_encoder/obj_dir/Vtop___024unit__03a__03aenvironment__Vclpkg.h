...
class Vtop___024unit__03a__03acollector;
...
class alignas(VL_CACHE_LINE_BYTES) Vtop___024unit__03a__03aenvironment__Vclpkg final {
  public:
...
class Vtop___024unit__03a__03aenvironment : public virtual VlClass {
  public:
    ...
    VlClassRef<Vtop___024unit__03a__03acollector> __PVT__col;
    ...
    VlClass* clone() const { return new Vtop___024unit__03a__03aenvironment(*this); }
  ...
  private:
    ...
    VlCoroutine __VnoInFunc_run____Vfork_1__4(Vtop__Syms* __restrict vlSymsp, VlForkSync __Vfork_1__sync);
