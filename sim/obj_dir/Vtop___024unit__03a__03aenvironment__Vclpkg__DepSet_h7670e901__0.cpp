...
VL_INLINE_OPT VlCoroutine Vtop___024unit__03a__03aenvironment::__VnoInFunc_run____Vfork_1__3(Vtop__Syms* __restrict vlSymsp, VlForkSync __Vfork_1__sync) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop___024unit__03a__03aenvironment::__VnoInFunc_run____Vfork_1__3\n"); );
    // Init
    VL_KEEP_THIS;
    // Body
    co_await VL_NULL_CHECK(this->__PVT__sb, "frame_encoder/environment.sv", 74)->__VnoInFunc_run(vlSymsp);
